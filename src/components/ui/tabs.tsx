...
// Original default Tabs component
const Tabs = TabsPrimitive.Root

// Add a contextual version of Tabs that can be used for different contexts
...
>(({ contextId = "default", value, defaultValue, ...props }, ref) => {
  ...
  return (
    <TabsPrimitive.Root
      ...
      defaultValue={contextualDefaultValue}
      {...props}
    />
  );
});
...
export { Tabs, TabsWithContext, TabsList, TabsTrigger, TabsContent }
